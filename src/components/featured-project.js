        ...
        <div className="project">
          ...
          <div className="project-details">
            <p className="project-text">
              {" "}
              This project is a modern online clothing store. It uses most of
              all the necessary features required to built a fully working
              modern website. This project is also deployed on netlify . Please
